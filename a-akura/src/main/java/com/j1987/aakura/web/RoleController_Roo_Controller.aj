...
import com.j1987.aakura.web.RoleController;
...
privileged aspect RoleController_Roo_Controller {
    ...
    public String RoleController.create(@Valid JRole JRole_, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String RoleController.update(@Valid JRole JRole_, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, JRole_);
    ...
    void RoleController.populateEditForm(Model uiModel, JRole JRole_) {
