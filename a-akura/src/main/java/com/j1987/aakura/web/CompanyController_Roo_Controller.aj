...
import com.j1987.aakura.web.CompanyController;
...
privileged aspect CompanyController_Roo_Controller {
    ...
    public String CompanyController.create(@Valid JCompany JCompany_, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String CompanyController.update(@Valid JCompany JCompany_, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, JCompany_);
    ...
    void CompanyController.populateEditForm(Model uiModel, JCompany JCompany_) {
